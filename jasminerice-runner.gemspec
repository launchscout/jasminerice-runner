...
Gem::Specification.new do |spec|
  ...
  spec.add_development_dependency 'coveralls', '~> 0.7', '>= 0.7'
  spec.add_development_dependency 'rake', '~> 11.0', '>= 11.0'
  spec.add_development_dependency 'yard', '~> 0.8', '>= 0.8.7'
  spec.add_development_dependency 'redcarpet', '~> 3.3', '>= 3.3'
  spec.add_development_dependency 'github-markup', '~> 1.3', '>= 1.3.3'
  spec.add_development_dependency 'inch', '~> 0.6', '>= 0.6'
end
